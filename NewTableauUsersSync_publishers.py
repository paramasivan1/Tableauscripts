...
dl_api_auth_user = "_bi_dev"
dl_api_auth_passwd = "312E3F3981A8B519A6"
...
def createNewUser(user_name):
    ...
    if user_name not in ('ppalanisamy','jstitzel','apachunoori','_tableau_admin'):
    	try:
        	newU = TSC.UserItem(user_name, 'Publisher')
        	...
        	E_user.site_role='Publisher'
        	server.users.update(E_user)
...
signin()
print ('signedin')
DLlist=['DL-abcd-New-Tableau-Publishers']
for dl in DLlist:
        DLUserList=[]
